...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    #
    # Thi driver is DEPRECATED in favor of 'DRIVE_TRAIN_TYPE == "ARDUINO_CONTROLLER"'
    # This driver will controll Arduino directly via pymata and firmata
    #
        from donkeycar.parts.actuator import Arduino, ArdPWMSteering, ArdPWMThrottle
        arduino_controller = Arduino(frequency=cfg.PWM_FREQUENCY)
