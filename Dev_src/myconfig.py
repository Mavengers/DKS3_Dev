...
STEERING_LEFT_PWM = 70   # One end of steering 
STEERING_RIGHT_PWM = 50   # Other end of the steering

#THROTTLE (aka ESC)
THROTTLE_PWM_CHANNEL = 1  # the Arduino pin to which throttle is connected
THROTTLE_FORWARD_PWM = 68 # Max forward throttle config
THROTTLE_STOPPED_PWM = 60 # Stopped throttle config 
THROTTLE_REVERSE_PWM = 55 # Max reverse throttle config

PWM_FREQUENCY = 50 # 50Hz is recommended for Servos

CAMERA_TYPE = "WEBCAM"   # WEBCAM via pyGame
